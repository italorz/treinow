...
function TodayExercise({ exercise, index, active, selectedId, onChoose }: any) {
  ...
  return <article className={`today-card ${selected ? "done" : ""}`}><span className="exercise-number">{String(index+1).padStart(2,"0")}</span><ExerciseVideo id={exercise.id} eager className="video-placeholder"/><div className="grow">
